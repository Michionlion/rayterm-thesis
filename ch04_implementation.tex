...
\ref{fig:rayterm-gpu_barycentric_coordinates} displays the barycentric coordinates in much the same way as normals were displayed for \texttt{rayterm-cpu}, and~\cite{fig:rayterm-gpu_geometric_normals} displays the actual geometric normals.
...
\label{fig:terminal_colorline}
  \end{subfigure}
  \begin{subfigure}[htb]{0.48\textwidth}
    \includegraphics[width=\textwidth]{impl-images/rtexplore/terminal_output}
