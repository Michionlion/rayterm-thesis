...
Algorithm \ref{widgmin} (from [cite]) shows a high-level description of an
algorithm. There are many options for the display of
pseudocode; this uses the {\tt algorithm2e} package [cite],
...
%   }
%  }
%  \caption{How to write algorithms (from [cite]
% \label{widgmin}
% \end{algorithm}
...
use of the {\tt listings} style file [cite].
