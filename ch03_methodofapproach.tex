...
\littlesection{Algorithms} \label{ch:methods:renderer:parallel:algorithms}
...
\littlesection{Design} \label{ch:methods:interface:tickit:design}

\littlesection{Algorithms} \label{ch:methods:interface:tickit:algorithms}
