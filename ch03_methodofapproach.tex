...
However, because \texttt{rayterm-gpu} integrates with the larger \name\ system, rendered images can also be seen with the \texttt{rtexplore} sample application, which we discuss in more detail in Section~\ref{ch:methods:interface:demo}.
...
\subsection{Sample \name\ Consumer} \label{ch:methods:interface:demo}
