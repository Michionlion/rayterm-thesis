...
\name\ utilizes the recursive ray-tracing algorithm first pioneered by Turner Whitted in his ground-breaking paper {\it An Improved Illumination Model for Shaded Display} \cite{whitted1980improved}.
...
Vectors are related to both multivariable calculus and linear algebra.
...
This is a specialized multiplication operation only applicable with $n = 3$ that results in a vector that is perpendicular to the plane defined by its operands.
